...
if [ $data = "ETTm2" ]
then
    python run.py --model tsmixer --data $data --seq_len $seq_len --pred_len $pred_len --learning_rate 0.001 --n_block 2 --dropout 0.9 --ff_dim 64
elif [ $data = "weather" ]
then
    python run.py --model tsmixer --data $data --seq_len $seq_len --pred_len $pred_len --learning_rate 0.0001 --n_block 4 --dropout 0.3 --ff_dim 32
